...
export function FAQAccordion(){const [open,setOpen]=useState<number|null>(0);return <section className="bg-[#fcfaf6] px-6 pb-28 md:px-12 lg:px-16"><div className="mx-auto grid max-w-[1200px] gap-10 lg:grid-cols-[.72fr_1.28fr] lg:gap-20">
