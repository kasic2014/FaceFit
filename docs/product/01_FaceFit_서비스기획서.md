...
FaceFit은 AI 직무 취업 준비자가 자신의 경험을 실제 면접과 유사한 음성 대화로 설명하고, 답변 내용·발화·시선·자세의 근거를 확인하며 반복 개선하는 데스크톱 웹 모의면접 코칭 서비스다.
...
| 정적 챗봇은 면접 몰입감이 낮다. | TTS+MuseTalk 질문 영상과 반응형 캐릭터 | 구현 가능한 시청각 질문 경험 |

## 핵심 기능

- 계정 진입과 이력서·지원 기업·목표 직무 입력
- AI 직무(`AiJobRole`)별 기술·HR·경영진 면접관 및 일반·압박 강도 선택
- 카메라·마이크·스피커 확인과 카메라 미리보기
- 기본 5문항과 답변 기반 꼬리질문 0~1개, 답변 완료 버튼, Space 단축키, 종료 확인
...
| 적응형 면접 | 기본 5문항, 기본 질문당 꼬리질문 0~1개, 버튼·Space와 3초 이후 VAD 자동 완료를 사용한다. |
...
- 정량 목표값은 사용자 테스트와 실제 운영 기준선 확보 뒤 승인한다.
...
- AI·백엔드 운영 환경과 기업 출처 갱신 책임
- 이력서·영상·음성의 보존 기간과 삭제 SLA
- 평가 점수 산식과 비교 집단의 정의

## 다음 협의 항목

- 06 요구사항과 API 명세의 P0 범위를 제품·개발·QA가 공동 승인한다.
